...
<body id="page-top">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">My Fit Station</a>
            </div>
    ...
    <section class="bg-primary" id="about">
        ...
        <div class="container">
            ...
            <div class=" form-group">
                <button type="button" id="login" class="btn btn-default" style="width: 100%; border-radius: 4px;"><i id="login_icon" class=""></i> Log in</button>
            </div>
